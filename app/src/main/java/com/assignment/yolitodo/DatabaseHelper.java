...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES = "CREATE TABLE " + TABLE_NAME + "(id INTEGER PRIMARY KEY, parentname TEXT,parentdate TEXT)";
    ...
    private static final String SELECT_PARENT_ENTRIES = "select * from " + TABLE_NAME + " order by id";
    ...
    public boolean addText (String date, String text) {
        ...
        contentValues.put("parentdate", date);
    ...
    public LinkedHashMap<String, String>  getAllItems(){
        ...
        while (!cursor.isAfterLast()){
            items.put(cursor.getString(cursor.getColumnIndex("parentname")),cursor.getString(cursor.getColumnIndex("parentdate")));
            cursor.moveToNext();
        }
        cursor.close();
